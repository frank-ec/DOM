(function(){
  ...
  document.addEventListener('DOMContentLoaded', function(){
	...
	*/
	...
	// alert(enlaces.length);  muestra el numero de enlaces en la pagina web
	...
	*/
	...
	var enlace = document.querySelectorAll('a');
        ...
        for(var i = 0; i< enlace.length;i++){
          ...
          // alert(enlace[i].innerText); muestra el contenido de texto de los enlaces
        }
	*/
 ...
 /*
        ...
        var textoEnlace = document.createTextNode('Buscar en Google');
